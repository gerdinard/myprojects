...
From PyDTI package: https://github.com/stephenliu0423/PyDTI.git 
"""
...
class NRLMF:
    ...
    def __init__(self, cfix=5, K1=5, K2=5, num_factors=50, theta=0.5, lambda_d=0.125, lambda_t=0.125, alpha=0.25, beta=0.125, max_iter=100):
    ...
    def evaluation(self, test_data, test_label):
        ...
        aupr_val = average_precision_score(test_label, np.array(scores),average='micro')
      #  aupr_val = auc(rec, prec)
        fpr, tpr, thr = roc_curve(test_label, np.array(scores))
        auc_val = roc_auc_score(test_label,np.array(scores),average='micro')
     #   auc_val = auc(fpr, tpr)
