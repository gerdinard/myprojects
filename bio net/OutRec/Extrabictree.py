# -*- coding: utf-8 -*-
"""
Created on Fri Feb  9 09:56:58 2018
...
def bdtrainwhole(X1,X2,chleft,chright,features2,thlist,Y):
    count = 0
    N1 = X1.shape[0]
    N2 = X2.shape[0]
    Nsamples = N1*N2 
...
def bdtestwhole(X1,X2,chleft,chright,features2,thlist,indprednode,prednode,Ytest):
    # testing phase
    count = 0
